...
void GenerateCode(HWND hDlg){
   ...
   unsigned char name[150]={0}, code1[2]={0}, code2[2]={0}, code_string[150]={0};
   int i=0, length=0, flag=0;
   unsigned long int checksum=0, cd1=0, cd2=0;
   ...
   sprintf(code_string,"%s%lu%s",code1,checksum,code2);
