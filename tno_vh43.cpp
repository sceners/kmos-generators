...
char prog_name[200]="HelpWriter for Visual Basic";
char date[11]="";
char about_box_caption[]="About...";
char first_title[]="Name";
char second_title[]="Registration Number";
...
void GenerateCode(HWND hDlg){
   ...
   static unsigned char table[26]={0x4c, 0x49, 0x54, 0x45, 0x44, 0x4f, 0x4e, 0x53, 0x46, 0x52, 0x42, 0x55, 0x48,
                                   0x41, 0x57, 0x43, 0x47, 0x4b, 0x4d, 0x51, 0x59, 0x4a, 0x50, 0x56, 0x58, 0x5a};
   static unsigned char table1[26]={0x57, 0x49, 0x4e, 0x45, 0x44, 0x54, 0x4f, 0x53, 0xac, 0x46, 0x52, 0x48, 0x55,
                                    0x41, 0x43, 0x47, 0x4b, 0x4d, 0x51, 0x59, 0x42, 0x4a, 0x50, 0x56, 0x58, 0x5a};
   unsigned char name[100]={0}, namez[100]={0}, code_string[100]={0};
   int i=0, k=0, length=0;
   long int total=0, eax=0, ebp08=0;
   ...
   if (IsDlgButtonChecked(hDlg,IDC_RADIO1))
   {
	...
	{
                if ((name[i]&0xFF) < 0x41 || (name[i]&0xFF) > 0x5A)
		{
                        goto endz1;
		}
                namez[k]=name[i];
    ...
    sprintf(code_string,"TNO-%lu",ebp08);
    }
    else
    {
	for (k=0,i=0;i<length;i++)
