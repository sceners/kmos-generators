...
char prog_name[200]="WebMinimizer *GERMAN*";
char date[11]="";
...
void GenerateCode(HWND hDlg){
   ...
   SHA_CTX context;
   unsigned char name[100], company[100]={0}, buffer[100], hash[20], *addon="TSM Chall start", *bah="LexO-n88H6piS-ji44", *bah1="TSM Inc copyright 1998", code_string[50]={0}, code[50]={0}, code_x[50]={0}, code_y[50]={0};
