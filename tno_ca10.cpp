...
char prog_name[200]="CD Autostart Creator";
char date[11]="";
...
void GenerateCode(HWND hDlg){
   ...
   unsigned long eax=0, cl=0, total=0;
   ...
   if (length < 5)
   {
        SetWindowText(hwndCode,"Enter your Name... (min 5)");
	return;
   }
   ...
   sprintf(code_string,"TNO%lu",total);
