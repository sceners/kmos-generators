...
char prog_name[200]="ACTX Form Animator VB Component";
char date[11]="";
char about_box_caption[]="About...";
char first_title[]="Company Name";
...
void GenerateCode(HWND hDlg){
   ...
   unsigned char name[100]={0}, code[50]={0}, code1[50]={0}, code2[50]={0}, codez1[50]={0}, codez2[50]={0}, ecxz[50]={0}, code_string[50]={0};
   int i=0, length=0;
   unsigned long ecx=0, esi=0;
   ...
   if (length < 3)
   {
	...
	sprintf(code2,"%c",ecxz[0]);
	strcat(codez2,code2);

	strcat(code_string,codez2);
	strcat(code_string,"-");
	strcat(code_string,codez1);
