...
char prog_name[200]="Readiris Pro";
char date[11]="";
char about_box_caption[]="About...";
char first_title[]="Identification number";
char second_title[]="Key number";
...
void GenerateCode(HWND hDlg){
   ...
   if (length < 1)
   {
        SetWindowText(hwndCode,"Enter your Identification number...");
	return;
   }
