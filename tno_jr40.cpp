...
char prog_name[200]="JAMMER 2000";
char date[11]="";
...
void GenerateCode(HWND hDlg){
   ...
   unsigned char name[100]={0}, code_string[150]={0};
   int i=0, length=0, tot_one=0, tot_two=0;
   ...
   sprintf(code_string,"%d000-JAMMER2000-%d",tot_one,tot_two);
