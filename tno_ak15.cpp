...
char prog_name[200]="Arkanoid";
char date[11]="";
char about_box_caption[]="About...";
char first_title[]="Reg. Name";
char second_title[]="Reg. Code";
...
void GenerateCode(HWND hDlg){
   ...
   unsigned char name[100]={0}, table[13]={9,9,9,9,9,9,9,9,9,9,9,9}, addon[35]="Press_any_key...Please_register...", code[20]={0}, code_string[20]={0};
