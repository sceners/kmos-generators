...
char prog_name[200]="Poker Patience Pack";
char date[11]="";
...
static unsigned char xor_table[]={0xD2, 0xD3, 0xD1, 0xCD, 0xDC, 0xAC, 0xDE, 0xD1,
				  0xE6, 0xDD, 0xDB, 0xE6, 0xDD, 0xE1, 0xBE, 0xF0,
				  0xE3, 0xE7, 0xF1};
