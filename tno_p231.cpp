...
char prog_name[200]="ProjectBrasil 2000";
char date[11]="";
...
void GenerateCode(HWND hDlg){
   ...
   unsigned char name[100]={0}, xiba[100]={0}, namez[100]={0}, code_string[100]={0};
   int i=0, k=0, length=0, flag=0;
   unsigned long int ecx=0, total=0, total1=0, total2=0;
   ...
   if(length<1) {
	...
	total2=total1 * length + 11;
	total=(length * 2 + length) + 17;

   sprintf(code_string,"%lu.%lu.%lu.%s",total,total1,total2,namez);
