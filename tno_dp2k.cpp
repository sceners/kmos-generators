...
char prog_name[200]="Dema Post-It";
char date[11]="";
char about_box_caption[]="About...";
char first_title[]="Name";
char second_title[]="Serial";
...
void GenerateCode(HWND hDlg){
   ...
   int i=0, k=0, length=0, len_name=0;
   long int tot_len=0, tot_len1=74, ecx=0;
   ...
   sprintf(code_string,"5%lu-%d%d%d",tot_len,name[0],name[1],tot_len1);
