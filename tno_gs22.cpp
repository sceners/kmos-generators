...
char prog_name[200]="Animated GIFSaver";
char date[11]="";
char about_box_caption[]="About...";
char first_title[]="Registered name";
...
void GenerateCode(HWND hDlg){
   ...
   unsigned char name[100]={0}, buffer[100]={0}, *addon="Animated GIFSaverPOWER", *addon1="Animated GIFSaverSTANDARD", code[100]={0};
   int i=0, length=0;
   ...
   if (length < 1)
   {
        SetWindowText(hwndCode,"Enter your Registered name...");
	return;
   }

   if (IsDlgButtonChecked(hDlg,IDC_RADIO1))
   {
        strcat(buffer,addon1);
	strcat(buffer,name);
