...
void GenerateCode(HWND hDlg){
   ...
   char name[50]={0}, code_string[100]={0}, err[50]={0}, errtemp[50]={0};
   int length=0, i=0, flag=0, final_code=0, xiba=0;
   ...
   //
   if(length<1){
      SetWindowText(hwndCode,"Enter the Serial Number given by the program...");
      return;
   }
   else
   {
   ...
   sprintf(code_string,"%d",final_code);
